...
module Jekyll
  ...
  class ArchiveGenerator < Generator
    ...
    def generate(site)
      # NOTE: Customization. Instead of all posts, we are only displaying an archive of blog posts.
      category_posts_blog = site.categories['blog']
      archive_data = group_by_month(category_posts_blog)
